...
&isMapView=false` : `https://www.kayak.com/hotels/${myTrip.destination
                      ...
                      <Menu>
                        ...
                        <MenuList bg="gray.700"> 
                          ...
                          >
                            <MenuItem _hover={{ bg: "gray.600" }} _focus={{ bg: "gray.600" }} onClick={()=> mixpanel.track('Shared Trip', {"platform":"WhatsApp"})}>
                          ...
                          >
                            <MenuItem _hover={{ bg: "gray.600" }} _focus={{ bg: "gray.600" }} onClick={()=> mixpanel.track('Shared Trip', {"platform":"Email"})}>
                          ...
                          >
                            <MenuItem _hover={{ bg: "gray.600" }} _focus={{ bg: "gray.600" }} onClick={()=> mixpanel.track('Shared Trip', {"platform":"Clipboard"})}>
